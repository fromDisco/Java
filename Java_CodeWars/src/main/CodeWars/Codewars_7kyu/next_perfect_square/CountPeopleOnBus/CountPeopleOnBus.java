 ...
 * number of people that get on the bus (the first item) and the number of people that get off the
 ...
 * @see <a href="https://www.codewars.com/kata/5648b12ce68d9daa6b000099/train/java">CodeWars Kata</a>
 * @see <a href="https://www.baeldung.com/java-stream-reduce">Baeldung stream.reduce()t</a>
 *
 */
public class CountPeopleOnBus {
    public static int countPassengers(ArrayList<int[]> stops) {
        return stops.stream().reduce(0, (sum, arr) -> sum + arr[0] - arr[1], Integer::sum);
    }
}
